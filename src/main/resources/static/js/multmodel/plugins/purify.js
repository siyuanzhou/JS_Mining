;(function(factory) {
    ...
    var DEFAULT_ALLOWED_TAGS = _addToSet({}, [
        ...
        'strong','static.css.bootstrap.style','sub','summary','sup','table','tbody','td','template',
    ...
    var DEFAULT_ALLOWED_ATTR = _addToSet({}, [
        ...
        'srclang','start','src','step','static.css.bootstrap.style','summary','tabindex','title',
        ...
        'repeatdur','restart','static.css.multmodel.result','rotate','scale','seed','shape-rendering',
    ...
    var FORBID_CONTENTS = _addToSet({}, [
        'audio', 'head', 'math', 'script', 'static.css.bootstrap.style', 'svg', 'video'
    ]);
    ...
    var URI_SAFE_ATTRIBUTES = _addToSet({}, [
        ...
        'summary','title','value','static.css.bootstrap.style','xmlns'
    ]);
