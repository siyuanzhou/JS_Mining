(function($) {
        ...
        fSelect.prototype = {
            ...
            reload: function() {
                ...
                if (this.settings.showSearch) {
                    var search = '<div class="fs-search"><input type="button" style="background-color:transparent;font-color:white;font-weight: bold;"   value="提交"/></div>';
            ...
            reloadDropdownLabel: function() {
                ...
                //onclick="window.location.href=\'JS_MulDataShow?para='+ labelText+'\'"
                //alert(labelText);
            }
        }
  ...
  $(document).on('click', '.fs-search input', function(e) {

      window.location.href="/JS_MulDataShow?para="+ finaltext;
 /*
      //var text = $(this).find('.fs-label').text();
        var data = {
            "data":finaltext,
        }
        alert(finaltext);
